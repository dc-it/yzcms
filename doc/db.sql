...
(
    ...
    `website_id`  bigint(0)                                       NOT NULL COMMENT '网站id',
...
-- ----------------------------
-- Table structure for cms_article_tag_relation
-- ----------------------------
DROP TABLE IF EXISTS `cms_article_tag_relation`;
...
(
    ...
    `website_id`  bigint(0)                                               NULL DEFAULT NULL COMMENT '所属网站id',
    `create_time` datetime(0)                                             NULL DEFAULT NULL COMMENT '创建时间',
    `update_time` datetime(0)                                             NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
