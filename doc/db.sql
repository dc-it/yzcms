...
(
    ...
    `sort`                  int(0)                                                  NULL DEFAULT NULL COMMENT '排序',
    `database_name`         varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL COMMENT '数据库名',
    `database_url`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据库访问地址   ip+端口，例如192.168.0.1:3306（只支持mysql数据库）',
    `database_username`     varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据库访问账户',
    `database_password`     varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据库访问密码',
    `database_local`        bit(1)                                                  NULL DEFAULT NULL COMMENT '数据库是否在本服务器',
    `create_time`           datetime(0)                                             NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`           datetime(0)                                             NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
...
(
    `id`                int(0)      NOT NULL AUTO_INCREMENT,
    `sys_role_id`       int(0)      NULL DEFAULT NULL,
    `sys_permission_id` int(0)      NULL DEFAULT NULL,
    `create_time`       datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`       datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
